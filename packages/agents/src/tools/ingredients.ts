...
export const INGREDIENT_TABLE: Record<string, IngredientData> = {
  ...
  "casein": { protein_g: 80, fat_g: 1, carbs_g: 3, fiber_g: 0, calories: 360 },
  ...
  "coconut cream": { protein_g: 2.3, fat_g: 24, carbs_g: 2.5, fiber_g: 0, calories: 239 },
  "coconut milk": { protein_g: 2.0, fat_g: 21.3, carbs_g: 2.8, fiber_g: 0, calories: 197 },
